...
type FooterProps = {
  isWithLetterSubscription?: boolean;
  isWithNavigation?: boolean;
  isMobileOnly?: boolean;
};

export default function Footer({
  isWithLetterSubscription = true,
  ...
  return (
    <footer
      className={cn(
        "w-full border-t border-border py-12",
        isMobileOnly ? "md:hidden" : "",
        isWithLetterSubscription ? "" : "border-none"
      )}
    >
      {isWithLetterSubscription && (
      ...
      {isWithNavigation && <Divider classNames="mt-12 mb-4" />}
